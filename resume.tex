...
\begin{document}
\name{Trevor Leibert}
\tagline{Computer Science and Software Engineering}
% Cropped to square from https://en.wikipedia.org/wiki/Marissa_Mayer#/media/File:Marissa_Mayer_May_2014_(cropped).jpg, CC-BY 2.0
%\photo{3.3cm}{profile.jpg}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{tleibert1999@gmail.com}
%   \phone{000-00-0000}
%  \mailaddress{Address, Street, 00000 County}
  \location{Cary, North Carolina}
%  \homepage{marissamayr.tumblr.com/}
%  \twitter{@marissamayer}
  \linkedin{https://www.linkedin.com/in/trevorleibert/}
...
\cvevent{Cloud Native Engineering Co-op}{Oracle Corporation}{June 2020 -- Jan 2021}{Morrisville, NC}
\begin{itemize}
...
\smallskip
\begin{itemize}
\item Strong problem solving ability
\smallskip
\item Ability to work effectively both independently and on teams
\smallskip
